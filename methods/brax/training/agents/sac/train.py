...
from stepping_gates.envs.wrappers import wrap as dgates_wrap
...
def train(
  ...
  env_state = jax.pmap(env.reset)(env_keys, env_params=training_state.env_params)
  ...
  for _ in range(num_evals_after_init):
    ...
    env_params=training_state.env_params)
      ...
      training_state = training_state.replace(env_params=new_env_params)
